  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_data_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_data_mob_form();
	}

  // ---------- Validate id
  function do_ajax_form_data_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_data_mob_validate_id(var_id, var_script_case_init, do_ajax_form_data_mob_validate_id_cb);
  } // do_ajax_form_data_mob_validate_id

  function do_ajax_form_data_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_data_mob_validate_id_cb

  // ---------- Validate nama
  function do_ajax_form_data_mob_validate_nama()
  {
    var nomeCampo_nama = "nama";
    var var_nama = scAjaxGetFieldText(nomeCampo_nama);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_data_mob_validate_nama(var_nama, var_script_case_init, do_ajax_form_data_mob_validate_nama_cb);
  } // do_ajax_form_data_mob_validate_nama

  function do_ajax_form_data_mob_validate_nama_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nama";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_data_mob_validate_nama_cb

  // ---------- Validate instansi
  function do_ajax_form_data_mob_validate_instansi()
  {
    var nomeCampo_instansi = "instansi";
    var var_instansi = scAjaxGetFieldText(nomeCampo_instansi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_data_mob_validate_instansi(var_instansi, var_script_case_init, do_ajax_form_data_mob_validate_instansi_cb);
  } // do_ajax_form_data_mob_validate_instansi

  function do_ajax_form_data_mob_validate_instansi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "instansi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_data_mob_validate_instansi_cb

  // ---------- Validate kategori
  function do_ajax_form_data_mob_validate_kategori()
  {
    var nomeCampo_kategori = "kategori";
    var var_kategori = scAjaxGetFieldText(nomeCampo_kategori);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_data_mob_validate_kategori(var_kategori, var_script_case_init, do_ajax_form_data_mob_validate_kategori_cb);
  } // do_ajax_form_data_mob_validate_kategori

  function do_ajax_form_data_mob_validate_kategori_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kategori";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_data_mob_validate_kategori_cb

  // ---------- Validate predikat
  function do_ajax_form_data_mob_validate_predikat()
  {
    var nomeCampo_predikat = "predikat";
    var var_predikat = scAjaxGetFieldText(nomeCampo_predikat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_data_mob_validate_predikat(var_predikat, var_script_case_init, do_ajax_form_data_mob_validate_predikat_cb);
  } // do_ajax_form_data_mob_validate_predikat

  function do_ajax_form_data_mob_validate_predikat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "predikat";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_data_mob_validate_predikat_cb

  // ---------- Validate email
  function do_ajax_form_data_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_data_mob_validate_email(var_email, var_script_case_init, do_ajax_form_data_mob_validate_email_cb);
  } // do_ajax_form_data_mob_validate_email

  function do_ajax_form_data_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_data_mob_validate_email_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_data_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_data_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_nama = scAjaxGetFieldText("nama");
    var var_instansi = scAjaxGetFieldText("instansi");
    var var_kategori = scAjaxGetFieldText("kategori");
    var var_predikat = scAjaxGetFieldText("predikat");
    ...
    scAjaxProcOn();
    x_ajax_form_data_mob_submit_form(var_id, var_nama, var_instansi, var_kategori, var_predikat, var_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_data_mob_submit_form_cb);
  } // do_ajax_form_data_mob_submit_form

  function do_ajax_form_data_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nama");
      scAjaxHideErrorDisplay("instansi");
      scAjaxHideErrorDisplay("kategori");
      scAjaxHideErrorDisplay("predikat");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_data_mob_submit_form_cb_after_alert);
  } // do_ajax_form_data_mob_submit_form_cb
  function do_ajax_form_data_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_data_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_data_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_data_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_data_mob_navigate_form_cb);
  } // do_ajax_form_data_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_data_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_data_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_data_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_data_mob_navigate_form_cb
  function do_ajax_form_data_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_data_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_data_mob_navigate_form_cb_after_alert
  function sc_hide_form_data_mob_form()
  {
  ...
  ajax_field_list[2] = "instansi";
  ajax_field_list[3] = "kategori";
  ajax_field_list[4] = "predikat";
  ...
  var ajax_error_list = {
    ...
    "instansi": {"label": "Instansi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kategori": {"label": "Kategori", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "predikat": {"label": "Predikat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["instansi"][1] = "instansi";
  ajax_field_mult["kategori"][1] = "kategori";
  ajax_field_mult["predikat"][1] = "predikat";
  ...
  var ajax_field_id = {
    ...
    "instansi": new Array("hidden_field_label_instansi", "hidden_field_data_instansi"),
    "kategori": new Array("hidden_field_label_kategori", "hidden_field_data_kategori"),
    "predikat": new Array("hidden_field_label_predikat", "hidden_field_data_predikat"),
