<?php
   include_once('kirim_serfitikat_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class kirim_serfitikat_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "kirim_serfitikat"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20200531"; 
      $this->nm_hr_criacao   = "011701"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20200531"; 
      $this->nm_hr_ult_alt   = "014849"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/kirim_serfitikat';
      ...
      if (isset($_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['kirim_serfitikat']['actual_lang']) || $_SESSION['scriptcase']['kirim_serfitikat']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['kirim_serfitikat']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("kirim_serfitikat_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['remove_margin']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["kirim_serfitikat"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["kirim_serfitikat"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "kirim_serfitikat_erro.class.php"); 
      $this->Erro = new kirim_serfitikat_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('kirim_serfitikat'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao']) && $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_perfil']) && $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['kirim_serfitikat']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['kirim_serfitikat']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['embutida_init']) 
      {
          if (!isset($_SESSION['instansi'])) 
          {
              $this->nm_falta_var .= "instansi; ";
          }
          ...
          {
              $this->nm_falta_var .= "kategori; ";
          }
          if (!isset($_SESSION['predikat'])) 
          {
              $this->nm_falta_var .= "predikat; ";
          }
          if (!isset($_SESSION['email'])) 
          {
              $this->nm_falta_var .= "email; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_conexao'], $this->root . $this->path_prod, 'eSertifikat', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['kirim_serfitikat']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new kirim_serfitikat_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['kirim_serfitikat']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['kirim_serfitikat']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['kirim_serfitikat']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['kirim_serfitikat'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['kirim_serfitikat']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['kirim_serfitikat']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('kirim_serfitikat') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['kirim_serfitikat']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['kirim_serfitikat']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['kirim_serfitikat']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['kirim_serfitikat']['exit'];
      ...
      {
          include_once("kirim_serfitikat_sc_mail_image.php");
      }
      $this->nm_data = new nm_data("id");
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "kirim_serfitikat_erro.class.php"); 
      $this->Erro      = new kirim_serfitikat_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['kirim_serfitikat']['contr_erro'] = 'on';
if (!isset($_SESSION['email'])) {$_SESSION['email'] = "";}
if (!isset($this->sc_temp_email)) {$this->sc_temp_email = (isset($_SESSION['email'])) ? $_SESSION['email'] : "";}
if (!isset($_SESSION['predikat'])) {$_SESSION['predikat'] = "";}
if (!isset($this->sc_temp_predikat)) {$this->sc_temp_predikat = (isset($_SESSION['predikat'])) ? $_SESSION['predikat'] : "";}
if (!isset($_SESSION['kategori'])) {$_SESSION['kategori'] = "";}
if (!isset($this->sc_temp_kategori)) {$this->sc_temp_kategori = (isset($_SESSION['kategori'])) ? $_SESSION['kategori'] : "";}
if (!isset($_SESSION['nama'])) {$_SESSION['nama'] = "";}
if (!isset($this->sc_temp_nama)) {$this->sc_temp_nama = (isset($_SESSION['nama'])) ? $_SESSION['nama'] : "";}
if (!isset($_SESSION['instansi'])) {$_SESSION['instansi'] = "";}
if (!isset($this->sc_temp_instansi)) {$this->sc_temp_instansi = (isset($_SESSION['instansi'])) ? $_SESSION['instansi'] : "";}
 $content = '<html><head>
...
<body>
	...
	<div class="certificate">
                    ...
                    <div class="top-text">'.$this->sc_temp_instansi.'</div>

                    <div class="honor-text"><b>'.$this->sc_temp_nama.'</b></div>

                    <p>telah mengikuti dengan baik <br>'.$this->sc_temp_kategori.'<br>dengan hasil/predikat</p>

                    <div class="honor-text no-padding"><b>'.$this->sc_temp_predikat.'</b></div>
...
$headers = "From: jais.rafi@gmail.com";
    ...
    {
        $Mens_Mail = Swift_Message::newInstance($mail_subject)->setBody($content)->setContentType("text/html");
    }
    else
    {
    ...
    $Temp_mail = $this->sc_temp_email;
    if (!is_array($Temp_mail))
    {
        $Temp_mail = explode(";", $this->sc_temp_email);
    }
...
if ($this->sc_mail_ok ) {
             echo "Message successfully sent!";
			  if (isset($this->sc_temp_instansi)) {$_SESSION['instansi'] = $this->sc_temp_instansi;}
 if (isset($this->sc_temp_nama)) {$_SESSION['nama'] = $this->sc_temp_nama;}
 if (isset($this->sc_temp_kategori)) {$_SESSION['kategori'] = $this->sc_temp_kategori;}
 if (isset($this->sc_temp_predikat)) {$_SESSION['predikat'] = $this->sc_temp_predikat;}
 if (isset($this->sc_temp_email)) {$_SESSION['email'] = $this->sc_temp_email;}
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_data') . "/", $this->nm_location, "","_self", 440, 630, "ret_self");
 };
          } else {
...
if (isset($this->sc_temp_predikat)) {$_SESSION['predikat'] = $this->sc_temp_predikat;}
if (isset($this->sc_temp_email)) {$_SESSION['email'] = $this->sc_temp_email;}
$_SESSION['scriptcase']['kirim_serfitikat']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['kirim_serfitikat'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['kirim_serfitikat']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['kirim_serfitikat']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_kirim_serfitikat($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imag_temp'] . "/sc_apl_default_eSertifikat.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['kirim_serfitikat']['glo_nm_path_imag_temp'] . "/sc_apl_default_eSertifikat.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "kirim_serfitikat") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_eSertifikat'])) {
               $_SESSION['scriptcase']['kirim_serfitikat']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_eSertifikat'];
           }
       }
   }
   ...
   if (isset($_POST["instansi"])) 
   {
       ...
       nm_limpa_str_kirim_serfitikat($_SESSION["instansi"]);
   }
   ...
   if (isset($_POST["nama"])) 
   {
       ...
       nm_limpa_str_kirim_serfitikat($_SESSION["nama"]);
   }
   if (isset($_GET["nama"])) 
   {
   ...
   if (isset($_POST["kategori"])) 
   {
       ...
       nm_limpa_str_kirim_serfitikat($_SESSION["kategori"]);
   }
   ...
   {
       $_SESSION["predikat"] = $_POST["predikat"];
       nm_limpa_str_kirim_serfitikat($_SESSION["predikat"]);
   }
   if (isset($_GET["predikat"])) 
   {
       $_SESSION["predikat"] = $_GET["predikat"];
       nm_limpa_str_kirim_serfitikat($_SESSION["predikat"]);
   }
   if (!isset($_SESSION["predikat"])) 
   {
   ...
   if (isset($_POST["email"])) 
   {
       ...
       nm_limpa_str_kirim_serfitikat($_SESSION["email"]);
   }
   if (isset($_GET["email"])) 
   {
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "kirim_serfitikat";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'kirim_serfitikat' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('kirim_serfitikat' == $sReferer || 'kirim_serfitikat_' == substr($sReferer, 0, 17))
       {
           $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'kirim_serfitikat')
   {
       $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['kirim_serfitikat']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/kirim_serfitikat_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_kirim_serfitikat($cadapar[1]);
   ...
   $contr_kirim_serfitikat = new kirim_serfitikat_apl();
   $contr_kirim_serfitikat->controle();
//
   function nm_limpa_str_kirim_serfitikat(&$str)
   {
