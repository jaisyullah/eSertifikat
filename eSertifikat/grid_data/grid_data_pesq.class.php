...
class grid_data_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_data_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_data_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_data_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_instansi')
      {
          $instansi = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_instansi($instansi);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nama')
      {
          $nama = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nama($nama);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_kategori')
      {
          $kategori = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_kategori($kategori);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_predikat')
      {
          $predikat = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_predikat($predikat);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_instansi($instansi)
   {
      $instansi = substr($this->Db->qstr($instansi), 1, -1);
            $instansi_look = substr($this->Db->qstr($instansi), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct instansi from " . $this->Ini->nm_tabela . " where  instansi like '%" . $instansi . "%' order by instansi"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nama($nama)
   {
      $nama = substr($this->Db->qstr($nama), 1, -1);
            $nama_look = substr($this->Db->qstr($nama), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nama from " . $this->Ini->nm_tabela . " where  nama like '%" . $nama . "%' order by nama"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_kategori($kategori)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kategori from " . $this->Ini->nm_tabela . " where  kategori like '%" . $kategori . "%' order by kategori"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_predikat($predikat)
   {
      $predikat = substr($this->Db->qstr($predikat), 1, -1);
            $predikat_look = substr($this->Db->qstr($predikat), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct predikat from " . $this->Ini->nm_tabela . " where  predikat like '%" . $predikat . "%' order by predikat"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['proc_res'])) 
    {
...
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_data').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_data').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_data').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
}
<?php
    }
    else
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_data/grid_data_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_data_ajax_search.js"></script>
 <script type="text/javascript" src="grid_data_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_data_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_data']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_data']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_instansi_cond#NMF#' + search_get_sel_txt('SC_instansi_cond') + '@NMF@';
  str_out += 'SC_instansi#NMF#' + search_get_text('SC_instansi') + '@NMF@';
  str_out += 'id_ac_instansi#NMF#' + search_get_title('select2-id_ac_instansi-container') + '@NMF@';
  str_out += 'SC_nama_cond#NMF#' + search_get_sel_txt('SC_nama_cond') + '@NMF@';
  str_out += 'SC_nama#NMF#' + search_get_text('SC_nama') + '@NMF@';
  str_out += 'id_ac_nama#NMF#' + search_get_title('select2-id_ac_nama-container') + '@NMF@';
  str_out += 'SC_kategori_cond#NMF#' + search_get_sel_txt('SC_kategori_cond') + '@NMF@';
  str_out += 'SC_kategori#NMF#' + search_get_text('SC_kategori') + '@NMF@';
  str_out += 'id_ac_kategori#NMF#' + search_get_title('select2-id_ac_kategori-container') + '@NMF@';
  str_out += 'SC_predikat_cond#NMF#' + search_get_sel_txt('SC_predikat_cond') + '@NMF@';
  str_out += 'SC_predikat#NMF#' + search_get_text('SC_predikat') + '@NMF@';
  str_out += 'id_ac_predikat#NMF#' + search_get_title('select2-id_ac_predikat-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-nama").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_nama",
      max_itens: "10",
   ...
   $("#SC_nama").val(e.params.data.id);
          nm_submit_form();
  });
  $(".sc-ui-autocomp-instansi").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_instansi",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_instansi").val(e.params.data.id);
          nm_submit_form();
  });
  $(".sc-ui-autocomp-kategori").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_kategori",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_kategori").val(e.params.data.id);
          nm_submit_form();
  });
  $(".sc-ui-autocomp-predikat").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_predikat",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_predikat").val(e.params.data.id);
          nm_submit_form();
  });
 });
</script>
...
{
 _nmAjaxShowMessage({title: "<?php echo $this->Ini->Nm_lang['lang_errm_errt']; ?>", message: mens, isModal: false, timeout: "", showButton: true, buttonLabel: "", topPos: "", leftPos: "", width: "", height: "", redirUrl: "", redirTarget: "", redirParam: "", showClose: false, showBodyIcon: false, isToast: false, toastPos: "", type: "error"});
}
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Data Sertifikat</div>
...
<?php
   ...
   {
      global 
             $instansi_cond, $instansi, $instansi_autocomp,
             $nama_cond, $nama, $nama_autocomp,
             $kategori_cond, $kategori, $kategori_autocomp,
             $predikat_cond, $predikat, $predikat_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $instansi = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['instansi']; 
          $instansi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['instansi_cond']; 
          $nama = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['nama']; 
          $nama_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['nama_cond']; 
          $kategori = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['kategori']; 
          $kategori_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['kategori_cond']; 
          $predikat = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['predikat']; 
          $predikat_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['predikat_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_instansi = (in_array($instansi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nama = (in_array($nama_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_kategori = (in_array($kategori_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_predikat = (in_array($predikat_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($instansi, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $instansi = substr($instansi, 0, $tmp_pos);
         }
      }
      if (!isset($nama) || $nama == "")
      {
      ...
      if (!isset($predikat) || $predikat == "")
      {
          $predikat = "";
      }
      if (isset($predikat) && !empty($predikat))
      {
         $tmp_pos = strpos($predikat, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $predikat = substr($predikat, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_instansi_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['instansi'])) ? $this->New_label['instansi'] : "Instansi"; ?></TD>
      
      <INPUT type="hidden" id="SC_instansi_cond" name="instansi_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_instansi" <?php echo $str_hide_instansi?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['instansi'])) ? $this->New_label['instansi'] : "Instansi";
 $nmgp_tab_label .= "instansi?#?" . $SC_Label . "?@?";
...
<?php
      ...
      $instansi_look = substr($this->Db->qstr($instansi), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct instansi from " . $this->Ini->nm_tabela . " where instansi = '$instansi_look' order by instansi"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$instansi]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$instansi];
      }
      else
      {
          $sAutocompValue = $instansi;
      }
?>
<INPUT  type="text" id="SC_instansi" name="instansi" value="<?php echo NM_encode_input($instansi) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-instansi" id="id_ac_instansi" name="instansi_autocomp"><?php if ('' !=  $instansi) { ?><option value="<?php echo $instansi ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>

        </TD>
       </TR>
      </TABLE>
     </TD>
      <TD id='SC_nama_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nama'])) ? $this->New_label['nama'] : "Nama"; ?></TD>
      
      <INPUT type="hidden" id="SC_nama_cond" name="nama_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nama" <?php echo $str_hide_nama?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nama'])) ? $this->New_label['nama'] : "Nama";
 $nmgp_tab_label .= "nama?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $nama_look = substr($this->Db->qstr($nama), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nama from " . $this->Ini->nm_tabela . " where nama = '$nama_look' order by nama"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$nama]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nama];
      }
      else
      {
          $sAutocompValue = $nama;
...
?>
<INPUT  type="text" id="SC_nama" name="nama" value="<?php echo NM_encode_input($nama) ?>"  size=40 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-nama" id="id_ac_nama" name="nama_autocomp"><?php if ('' !=  $nama) { ?><option value="<?php echo $nama ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>

        </TD>
       </TR>
      </TABLE>
     </TD>
      <TD id='SC_kategori_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['kategori'])) ? $this->New_label['kategori'] : "Kategori"; ?></TD>
      
      <INPUT type="hidden" id="SC_kategori_cond" name="kategori_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kategori" <?php echo $str_hide_kategori?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['kategori'])) ? $this->New_label['kategori'] : "Kategori";
 $nmgp_tab_label .= "kategori?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $kategori_look = substr($this->Db->qstr($kategori), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kategori from " . $this->Ini->nm_tabela . " where kategori = '$kategori_look' order by kategori"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      {
          $sAutocompValue = $kategori;
      }
?>
<INPUT  type="text" id="SC_kategori" name="kategori" value="<?php echo NM_encode_input($kategori) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-kategori" id="id_ac_kategori" name="kategori_autocomp"><?php if ('' !=  $kategori) { ?><option value="<?php echo $kategori ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>

        </TD>
       </TR>
      </TABLE>
     </TD>
      <TD id='SC_predikat_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['predikat'])) ? $this->New_label['predikat'] : "Predikat"; ?></TD>
      
      <INPUT type="hidden" id="SC_predikat_cond" name="predikat_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_predikat" <?php echo $str_hide_predikat?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['predikat'])) ? $this->New_label['predikat'] : "Predikat";
 $nmgp_tab_label .= "predikat?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $predikat_look = substr($this->Db->qstr($predikat), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct predikat from " . $this->Ini->nm_tabela . " where predikat = '$predikat_look' order by predikat"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$predikat]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$predikat];
      }
      else
      {
          $sAutocompValue = $predikat;
      }
?>
<INPUT  type="text" id="SC_predikat" name="predikat" value="<?php echo NM_encode_input($predikat) ?>"  size=25 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-predikat" id="id_ac_predikat" name="predikat_autocomp"><?php if ('' !=  $predikat) { ?><option value="<?php echo $predikat ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['opc_psq'])
   {
...
{
?>
<iframe id="nmsc_iframe_grid_data" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_data" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_data_pesq"  name="nm_iframe_grid_data_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_data_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_data').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   nm_campos_between(document.getElementById('id_vis_instansi'), document.F1.instansi_cond, 'instansi');
   document.F1.instansi.value = "";
   document.F1.instansi_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_nama'), document.F1.nama_cond, 'nama');
   document.F1.nama.value = "";
   document.F1.nama_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_kategori'), document.F1.kategori_cond, 'kategori');
   document.F1.kategori.value = "";
   document.F1.kategori_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_predikat'), document.F1.predikat_cond, 'predikat');
   document.F1.predikat.value = "";
   document.F1.predikat_autocomp.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "eSertifikat/grid_data";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_instansi_cond'] = 'cond';
      $tp_fields['SC_instansi'] = 'text_aut';
      $tp_fields['id_ac_instansi'] = 'select2_aut';
      $tp_fields['SC_nama_cond'] = 'cond';
      $tp_fields['SC_nama'] = 'text_aut';
      $tp_fields['id_ac_nama'] = 'select2_aut';
      $tp_fields['SC_kategori_cond'] = 'cond';
      $tp_fields['SC_kategori'] = 'text_aut';
      $tp_fields['id_ac_kategori'] = 'select2_aut';
      $tp_fields['SC_predikat_cond'] = 'cond';
      $tp_fields['SC_predikat'] = 'text_aut';
      $tp_fields['id_ac_predikat'] = 'select2_aut';
   ...
   {
      global $instansi_cond, $instansi, $instansi_autocomp,
             $nama_cond, $nama, $nama_autocomp,
             $kategori_cond, $kategori, $kategori_autocomp,
             $predikat_cond, $predikat, $predikat_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($instansi_autocomp) && empty($instansi))
      {
          $instansi = $instansi_autocomp;
      }
      if (!empty($nama_autocomp) && empty($nama))
      {
          $nama = $nama_autocomp;
      }
      if (!empty($kategori_autocomp) && empty($kategori))
      {
          $kategori = $kategori_autocomp;
      }
      if (!empty($predikat_autocomp) && empty($predikat))
      {
          $predikat = $predikat_autocomp;
      }
      $instansi_cond_salva = $instansi_cond; 
      if (!isset($instansi_input_2) || $instansi_input_2 == "")
      {
          $instansi_input_2 = $instansi;
      }
      $nama_cond_salva = $nama_cond; 
      if (!isset($nama_input_2) || $nama_input_2 == "")
      {
          $nama_input_2 = $nama;
      }
      $kategori_cond_salva = $kategori_cond; 
      if (!isset($kategori_input_2) || $kategori_input_2 == "")
      {
          $kategori_input_2 = $kategori;
      }
      $predikat_cond_salva = $predikat_cond; 
      if (!isset($predikat_input_2) || $predikat_input_2 == "")
      {
          $predikat_input_2 = $predikat;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['instansi'] = $instansi; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['instansi_cond'] = $instansi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['nama'] = $nama; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['nama_cond'] = $nama_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['kategori'] = $kategori; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['kategori_cond'] = $kategori_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['predikat'] = $predikat; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['predikat_cond'] = $predikat_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['instansi'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['instansi'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['instansi'] = $instansi;
      }
      $nama_look = substr($this->Db->qstr($nama), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nama from " . $this->Ini->nm_tabela . " where nama = '$nama_look' order by nama"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nama'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nama'] = $nama;
      }
      $kategori_look = substr($this->Db->qstr($kategori), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct kategori from " . $this->Ini->nm_tabela . " where kategori = '$kategori_look' order by kategori"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['kategori'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['kategori'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['kategori'] = $kategori;
      }
      $predikat_look = substr($this->Db->qstr($predikat), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct predikat from " . $this->Ini->nm_tabela . " where predikat = '$predikat_look' order by predikat"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['predikat'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['predikat'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['predikat'] = $predikat;
      }

      //----- $instansi
      $this->Date_part = false;
      if (isset($instansi) || $instansi_cond == "nu" || $instansi_cond == "nn" || $instansi_cond == "ep" || $instansi_cond == "ne")
      {
         $this->monta_condicao("instansi", $instansi_cond, $instansi, "", "instansi");
      }

      //----- $nama
      $this->Date_part = false;
      if (isset($nama) || $nama_cond == "nu" || $nama_cond == "nn" || $nama_cond == "ep" || $nama_cond == "ne")
      {
         $this->monta_condicao("nama", $nama_cond, $nama, "", "nama");
      }

      //----- $kategori
      $this->Date_part = false;
      if (isset($kategori) || $kategori_cond == "nu" || $kategori_cond == "nn" || $kategori_cond == "ep" || $kategori_cond == "ne")
      {
         $this->monta_condicao("kategori", $kategori_cond, $kategori, "", "kategori");
      }

      //----- $predikat
      $this->Date_part = false;
      if (isset($predikat) || $predikat_cond == "nu" || $predikat_cond == "nn" || $predikat_cond == "ep" || $predikat_cond == "ne")
      {
         $this->monta_condicao("predikat", $predikat_cond, $predikat, "", "predikat");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_data']['cond_pesq'] .= $this->NM_operador;
