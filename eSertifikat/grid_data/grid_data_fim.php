...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["eSertifikat_____grid_data"]))
   {
      unset($_SESSION['session_sec_aplicacao']["eSertifikat_____grid_data"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_data'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_data']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_data']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_data']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_data']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_data']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_data']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_data']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_data']['embutida_filho'] as $ind => $sc_init)
          {
