...
<?php
   ...
   $Ord_Cmp = new grid_data_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_data_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["id"] : "ID";
   $tab_ger_campos['nama'] = "on";
   $tab_def_campos['nama'] = "nama";
   $tab_labels["nama"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["nama"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["nama"] : "Nama";
   $tab_ger_campos['instansi'] = "on";
   $tab_def_campos['instansi'] = "instansi";
   $tab_labels["instansi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["instansi"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["instansi"] : "Instansi";
   $tab_ger_campos['kategori'] = "on";
   $tab_def_campos['kategori'] = "kategori";
   $tab_labels["kategori"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["kategori"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["kategori"] : "Kategori";
   $tab_ger_campos['predikat'] = "on";
   $tab_def_campos['predikat'] = "predikat";
   $tab_labels["predikat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["predikat"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["predikat"] : "Predikat";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["email"] : "Email";
   $tab_ger_campos['cetak'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cetak'] = "Cetak";
   }
   else
   {
       $tab_def_campos['cetak'] = "";
   }
   $tab_labels["cetak"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["cetak"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["cetak"] : "Cetak";
   $tab_ger_campos['kirim'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['kirim'] = "Kirim";
   }
   else
   {
       $tab_def_campos['kirim'] = "";
   }
   $tab_labels["kirim"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_data']['labels']["kirim"])) ? $_SESSION['sc_session'][$sc_init]['grid_data']['labels']["kirim"] : "Kirim";
   $tab_ger_campos['cetak'] = "none";
   $tab_ger_campos['kirim'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_data']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_data']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_data']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_data']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_data']['ordem_quebra'] as $campo => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_data_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_data']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
