<?php
@session_start() ;
$_SESSION['scriptcase']['grid_data']['sc_process_barr'] = true;
require_once('../grid_data/index.php');
unset($_SESSION['scriptcase']['grid_data']['sc_process_barr']);
$ExportCtrl = new grid_data_export_control;
$ExportCtrl->Export_barr();

class grid_data_export_control
{
