...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_instansi"  <?php echo $str_hide_instansi?>><?php
      if ($instansi != "")
      {
      $instansi_look = substr($this->Db->qstr($instansi), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nama"  <?php echo $str_hide_nama?>><?php
      if ($nama != "")
      {
      $nama_look = substr($this->Db->qstr($nama), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nama" id="id_ac_nama" name="nama_autocomp"><?php if ('' !=  $nama) { ?><option value="<?php echo $nama ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_kategori"  <?php echo $str_hide_kategori?>><?php
      if ($kategori != "")
      {
      $kategori_look = substr($this->Db->qstr($kategori), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_predikat"  <?php echo $str_hide_predikat?>><?php
      if ($predikat != "")
      {
      $predikat_look = substr($this->Db->qstr($predikat), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-predikat" id="id_ac_predikat" name="predikat_autocomp"><?php if ('' !=  $predikat) { ?><option value="<?php echo $predikat ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
