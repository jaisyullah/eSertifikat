 ...
 */
    ...
    $SC_cod_proj = "eSertifikat";
    $SC_apl_proc = "grid_data";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_data']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_data']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_data']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_data']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['grid_data']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['grid_data']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['grid_data']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_data']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_data']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_data']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
